...
class _TherapistDetailScreenState extends State<TherapistDetailScreen> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              context,
              MaterialPageRoute(
                builder: (context) => FeedbackForm(therapistId: 'therapist120'),
              ),
            );
                    },
                    icon: Icon(Icons.star_outline, size: 20, color: Color(0xff881736)),
 ...
 void _showConfirmationMessage(BuildContext context) {
  ...
  // Call the registerBooking method to book the appointment
  bookingService.registerBooking(
    'user_id', // Pass the user ID here
    Booking(
      id: 'appointment', // Pass the appointment ID here
      appointmentType: selectedAppointmentType!,
      timeSlot: selectedTimeSlot!, date: selectedDate!,
    ),
  );
}
}
