...
//             Image.asset('assets/images/logo.png',height:100),
//             SizedBox(height:10),
//                 Center(child: Text('Welcome Back',style: TextStyle(color: Colors.white,fontSize: 28),)),
//                 SizedBox(height:10),
//                 Text('Sign In If You Have An Account',style: TextStyle(color: Colors.white,fontSize: 10,)),
//                 SizedBox(height: 30,),
...
//                         // Validated successfully, handle login logic here
//                         // For example, you can navigate to the next screen
//                         print('Email/Phone: $_emailOrPhone');
//                       }
//                    }, child: Text('Login',style: TextStyle(color: Colors.white),),height: 30,width: 100,color:Color(0xff281537) ,),
//                     SizedBox(height: 20),
//               Padding(
